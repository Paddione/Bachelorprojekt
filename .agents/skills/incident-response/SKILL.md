...
> Pod-Status: `kubernetes.pod-list-in-namespace({ namespace: "workspace" })` — CrashLoopBackOff, OOMKilled, Pending erkennen.
> Logs: `kubernetes.pod-log({ namespace: "workspace", name: "<pod>" })`
> Einzelnes Pod-Detail: `kubernetes.pod-get({ namespace: "workspace", name: "<pod>" })`
