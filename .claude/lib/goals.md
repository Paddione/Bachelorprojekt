...
**Baseline-Stichtag:** `2026-07-01` · **Zuletzt gemessen:** `2026-08-15` · **Dashboard:** Homepage-Section `#health`
...
| **G-SEC04** | Sealing-Cert Restlaufzeit | 3603 Tage ✓ | ≥ 30 Tage | `openssl x509 -enddate -noout -in environments/certs/*.pem` |
