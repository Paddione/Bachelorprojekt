...
| **G-DOC02** | Root-CLAUDE.md Zeilen | 223 ⚠ | ≤ 200 | `wc -l < CLAUDE.md` |
...
| **G-AGENTIC11** | CLAUDE.md opencode-Liste vs opencode.jsonc | 1 ⚠ | 0 | `comm -3 <(grep opencode-Liste \| extract backtick-names) <(mcp_servers opencode.jsonc)` |
