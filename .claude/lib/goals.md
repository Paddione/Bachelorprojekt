...
**Baseline-Stichtag:** `2026-07-01` · **Zuletzt gemessen:** `2026-08-14` · **Dashboard:** Homepage-Section `#health`
...
| **G-SEC04** | Sealing-Cert Restlaufzeit | 3604 Tage ✓ | ≥ 30 Tage | `openssl x509 -enddate -noout -in environments/certs/*.pem` |
...
| **G-DB04** | Backup-Alter (h) seit letztem db-backup-Job | 483 ⚠ | ≤ 26h | `db_scalar Backup-Alter (health-goals-check.sh); Regressionswache T001738` |
