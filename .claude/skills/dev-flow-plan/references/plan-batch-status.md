...
Belege `STAGED_PLANS` bzw. `PLANNING_COUNT` aus den MCP-Ergebnissen. **Fallback:** der kubectl-Block unten. Siehe [`MCP-Tool-Guide`](.claude/skills/references/mcp-tool-guide.md).
