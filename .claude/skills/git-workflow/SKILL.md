...
(Summary + Test Plan): [git-workflow-procedures](.claude/skills/references/git-workflow-procedures.md).
...
# sichtbar bleibt. Lebenszyklus-SSOT: .claude/skills/references/session-coordination.md
