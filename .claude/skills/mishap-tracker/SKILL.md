...
- `"Rollup-Container-Append: 10 Mishaps an den Container angehaengt. Verbleibend: 2."` → Schwelle (10) erreicht, Rollup-Container wurde befüllt (`ticket-mcp` hängt per `add-comment` an den `plan_staged`-Rollup-Container an)
