...
> **Warum nicht MCP-first (T002256):** `mcp__ticket-mcp-node__archive_plan` schlägt aus einem
...
> `mcp__ticket-mcp-node__archive_plan({ id, slug, branch, plan_file, pr })` weiterhin.
...
> CI-Runnern. Der Archiv-Commit entsteht deshalb auf einem Archiv-Branch
