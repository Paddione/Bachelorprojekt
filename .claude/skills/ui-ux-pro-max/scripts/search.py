...
Persistence (Master + Overrides pattern):
  --persist    Save design system to packages/design-system/MASTER.md
  --page       Also create a page-specific override file in packages/design-system/pages/
"""
...
if __name__ == "__main__":
    ...
    # Persistence (Master + Overrides pattern)
    parser.add_argument("--persist", action="store_true", help="Save design system to packages/design-system/MASTER.md (creates hierarchical structure)")
    parser.add_argument("--page", type=str, default=None, help="Create page-specific override file in packages/design-system/pages/")
    ...
    if args.design_system:
        ...
        if args.persist:
            ...
            print("\n" + "=" * 60)
            print(f"✅ Design system persisted to packages/design-system/{project_slug}/")
            print(f"   📄 packages/design-system/{project_slug}/MASTER.md (Global Source of Truth)")
            if args.page:
                page_filename = args.page.lower().replace(' ', '-')
                print(f"   📄 packages/design-system/{project_slug}/pages/{page_filename}.md (Page Overrides)")
            print("")
            print(f"📖 Usage: When building a page, check packages/design-system/{project_slug}/pages/[page].md first.")
