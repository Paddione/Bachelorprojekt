...
`.opencode/skills/feature-intake/`-Verzeichnis.
...
| `huggingface-datasets` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Dataset-Viewer-API-Workflows. |
| `huggingface-llm-trainer` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | LLM-Training mit TRL/Unsloth auf Hugging Face Jobs. |
| `huggingface-local-models` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Lokale Modelle mit llama.cpp/GGUF. |
| `huggingface-lora-space-builder` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Gradio-Demo auf HF Spaces fuer LoRA bauen. |
| `huggingface-paper-publisher` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Research-Papers auf dem Hub publizieren. |
| `huggingface-papers` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Paper-Seiten und -Metadaten nachschlagen. |
| `huggingface-tool-builder` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Reusable Scripts auf der HF-API bauen. |
| `huggingface-trackio` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Training-Experimente mit Trackio verfolgen. |
| `huggingface-vision-trainer` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Vision-Modelle (Detection/Klassifikation/SAM) trainieren. |
| `huggingface-zerogpu` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | ZeroGPU-Spaces-Constraints (Spaces-GPU). |
| `train-sentence-transformers` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Sentence-Transformers trainieren/fine-tunen. |
| `transformers-js` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | ML-Modelle in JavaScript/TypeScript ausfuehren. |
| `trl-training` | HuggingFace skill pack (auto-installed 2026-08-23, T015174) | Transformer-LMs mit TRL trainieren. |
<!-- vendor-skills:end -->
...
`.opencode/skills/references/grilling-to-ticket.md`. Skill-Autoren: NICHT pro SKILL.md
