...
[`ticket-ops-procedures`](.opencode/skills/references/ticket-ops-procedures.md)
...
[`ticket-ops-procedures`](.opencode/skills/references/ticket-ops-procedures.md) §Phase 1.
...
[`ticket-ops-procedures`](.opencode/skills/references/ticket-ops-procedures.md) §Phase 1.5.
...
[`ticket-ops-procedures`](.opencode/skills/references/ticket-ops-procedures.md) §Phase 2.
...
[`ticket-ops-procedures`](.opencode/skills/references/ticket-ops-procedures.md) §Phase 3.
...
> Stale-Regel: [`ticket-ops-procedures`](.opencode/skills/references/ticket-ops-procedures.md)
> §Step 3.6.
>
