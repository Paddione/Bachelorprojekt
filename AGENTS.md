...
| `qwen38-primary` | `llamacpp-native/qwen3.8-27b`, `mode: primary`, write-capable | Dedizierter lokaler Primary auf nativem llama.cpp (:8080) mit Qwen 3.8 27B, 122.880 ctx, 4-bit KV cache, Anti-Loop & Prefix-Cache Prompting |
