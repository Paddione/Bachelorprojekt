...
| `gptoss` | `freetoken-local/Qwen3.6-35B-A3B-NVFP4` (FreeToken-native, :1919) | Local bulk work. **Name lügt** — alle lokalen Subagenten seit T014028 auf FreeToken-native. `write=deny`, `edit=allow` |
| `devstral` | `freetoken-local/Qwen3.6-35B-A3B-NVFP4` (FreeToken-native, :1919) | Local work. **Name lügt** — alle lokalen Subagenten seit T014028 auf FreeToken-native |
