...
What annoys him: being asked obvious questions when context is available, re-explaining decisions already in the code, overly cautious "are you sure?" prompts for routine work.

What he values: things just working, minimal noise, knowing the agent read the files before asking.
