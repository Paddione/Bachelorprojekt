...
Recreates the Kore.com marketing page using `colors_and_type.css` + `styles/website.css` + `styles/app.css` from the codebase.

## Components (`Website.jsx`)
- `SubNav` — sticky brand + center links + actions
- `Hero` — eyebrow ticker, italic-serif headline, lede, CTAs, 4-up meta-row
