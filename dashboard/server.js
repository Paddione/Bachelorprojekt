...
const ALLOWED_COMMANDS = new Set([
  ...
  'ha:status', 'ha:setup', 'ha:cert-renew',
  ...
  'workspace:port-forward', 'workspace:psql', 'tracking:psql',
  'workspace:verify', 'workspace:verify:all-prods',
  'workspace:dsgvo-check', 'workspace:vaultwarden:seed', 'workspace:sync-db-passwords',
  ...
  'mcp:deploy', 'mcp:status', 'mcp:logs', 'mcp:restart', 'mcp:select',
  'claude-code:setup', 'gemini:setup',
  'website:deploy', 'website:build', 'website:status', 'website:dev',
  'wireguard:setup', 'wireguard:up', 'wireguard:down', 'wireguard:status',
  'gpu-worker:start', 'gpu-worker:stop', 'gpu-worker:status', 'gpu-worker:logs',
  'gpu-worker:switch-dev', 'gpu-worker:switch-prod',
  'whisper:deploy', 'whisper:status', 'whisper:logs',
  'brett:build', 'brett:push', 'brett:deploy', 'brett:bot-setup', 'brett:logs',
