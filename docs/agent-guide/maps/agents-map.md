...
| devstral-primary | primary | freetoken-local/active | nein | Tab-selectable primary. Seit T013360 auf qwen38-220k (Qwen 3.8 27B, 114688 ctx, text-only). |
...
| gemma12-primary | primary | freetoken-local/active | nein | Tab-selectable primary. Seit T013360 auf qwen38-220k (Qwen 3.8 27B, 114688 ctx, text-only). |
| gemma26-primary | primary | freetoken-local/active | nein | Tab-selectable primary local agent. Seit T013360 auf qwen38-220k (Qwen 3.8 27B, 114688 ctx, text-only). Alle lokalen Agenten teilen dieses eine Loadout. |
| gemma26-throughput-primary | primary | freetoken-local/active | nein | Tab-selectable primary. Seit T013360 auf qwen38-220k (Qwen 3.8 27B, 114688 ctx, text-only). |
| gemma26-vision | primary | freetoken-local/active | nein | Tab-selectable primary, no subagent dispatch. Seit T013360 auf qwen38-220k (Qwen 3.8 27B, 114688 ctx, text-only). |
...
| gptoss-primary | primary | freetoken-local/active | nein | Tab-selectable primary. Seit T013360 auf qwen38-220k (Qwen 3.8 27B, 114688 ctx, text-only). Die Kontextzahl ist laufzeitrelevant: opencode timet Auto-Compact bei 95 % der deklarierten Grenze. |
...
| qwen38-primary | primary | freetoken-local/active | nein | Tab-selectable text-only primary, modellagnostisch via FreeToken-Alias 'active' (:1919) [T014105]; zuvor qwen38-220k-Loadout [T013109] |
