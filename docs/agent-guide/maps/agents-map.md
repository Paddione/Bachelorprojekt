...
| qwen38-primary | primary | llamacpp-native/qwen3.8-27b | ja | PRIMARY: Qwen 3.8 27B native llama.cpp (:8080) — 122.880 ctx, 4-bit KV cache, Flash Attention. Cache-optimiertes Prompting, Anti-Looping & Termination Guards. |
