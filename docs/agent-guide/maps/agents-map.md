...
| local | subagent | llamacpp-local/Qwen3.8-27B-dualgpu | nein | Sole local implementation subagent: Qwen3.8-27B dense via llama.cpp :1919 (dual-GPU 5070 Ti + 3060 Ti, 153600 served KV, ~35 tok/s decode, gemessen 2026-09-23) [T900348]. Sequential dispatch with per-packet budget_tokens (S ~32k / M ~80k / L ~100k). |
