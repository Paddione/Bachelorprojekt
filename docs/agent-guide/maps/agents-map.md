...
| orchestrator | primary | llamacpp-local/gemma26-throughput | ja | Primary orchestrator, dispatches the local family subagents (gptoss/devstral/gemma/gemma12) sequentially |
