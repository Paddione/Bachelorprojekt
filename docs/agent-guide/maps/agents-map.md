...
| devstral | subagent | freetoken-local/active | nein | Modellagnostisch auf FreeToken-native (:1919) — Alias 'active' serviert das residente Modell (Plugin freetoken-active setzt das Limit beim Start) [T900162]. |
...
| gemma | subagent | freetoken-local/active | nein | Modellagnostisch auf FreeToken-native (:1919) — Alias 'active' serviert das residente Modell (Plugin freetoken-active setzt das Limit beim Start) [T900162]. |
| gemma12 | subagent | freetoken-local/active | nein | Modellagnostisch auf FreeToken-native (:1919) — Alias 'active' serviert das residente Modell (Plugin freetoken-active setzt das Limit beim Start) [T900162]. |
| gptoss | subagent | freetoken-local/active | nein | NAME luegt ueber das Modell. Modellagnostisch auf FreeToken-native (:1919) — der Alias 'active' serviert immer das gerade residente Modell (Plugin freetoken-active setzt das Kontext-Limit beim Start). Name bleibt als Dispatch-Schnittstelle [T900162]. |
...
| qwen38 | subagent | freetoken-local/active | nein | qwen38 family: modellagnostisch auf FreeToken-native (:1919) — Alias 'active' serviert das residente Modell. EIN Slot — nur sequenziell dispatchen, nie neben sich selbst oder einem anderen lokalen Agenten [T900162] |
...
| reviewer | subagent | freetoken-local/active | nein | Factory reviewer role — read/grep/glob/tests only; no edit/write/bash/task dispatch (Orchestrator applies review edits) [T900074] |
