...
| qwen38-primary | primary | llamacpp-local/qwen38-220k | ja | PRIMARY: Local Qwen 3.8 27B UD-IQ4_XS via llama.cpp (120k ctx / 122880 tokens, loadout qwen38-220k on port 8094). Autonomous ticket-hammering agent: prioritizes critical tickets, plans (/dev-flow-plan), explores (/opsx:explore), executes, and archives. |
