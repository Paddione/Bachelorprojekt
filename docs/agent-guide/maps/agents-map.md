...
| devstral | subagent | llamacpp-local/gemma26-factory | nein | NAME luegt ueber das Modell: faehrt gemma26-factory (167168 ctx gesamt, Port 8091) — Name bleibt als Dispatch-Schnittstelle [T003204] |
...
| gemma | subagent | llamacpp-local/gemma26-factory | nein | gemma family: Gemma 4 26B A4B IT UD-IQ4_XS, Loadout gemma26-factory auf Port 8091 (live GPU-Loadout) [T012409] |
...
| gemma26-throughput-primary | primary | llamacpp-local/gemma26-factory | nein | Tab-selectable primary, seit T012409 auf gemma26-factory (Port 8091), 167168 ctx gesamt gemessen, 122-128 tok/s [T003065/T012409] |
...
| gptoss | subagent | llamacpp-local/gemma26-factory | nein | NAME luegt ueber das Modell: faehrt seit T012409 gemma26-factory (167168 ctx gesamt, Port 8091), weil das Gateway nur noch dieses Modell listet. Der Name bleibt, weil er die Dispatch-Schnittstelle des Orchestrators ist — Umbenennen ist ein eigener Vorgang [T003204] |
| gptoss-primary | primary | llamacpp-local/gemma26-factory | nein | Tab-selectable primary, seit T012409 auf gemma26-factory (Port 8091), 167168 ctx gesamt — gemma26-throughput wird vom Gateway nicht mehr gelistet. Die Kontextzahl ist laufzeitrelevant: opencode timet Auto-Compact bei 95 % der deklarierten Grenze [T003065/T003204] |
| orchestrator | primary | llamacpp-local/gemma26-factory | ja | Primary orchestrator, dispatches the local family subagents (gptoss/devstral/gemma/gemma12) sequentially |
