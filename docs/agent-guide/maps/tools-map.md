...
| opencode-flow-plan | OpenCode-Planungs-Skill (opencode-flow-plan) | skill | opencode | 🟡 Vorsicht | Planung unter opencode: Brainstorming, Feature/Fix/Chore-Entscheidung, OpenSpec-Plan-Erstellung. | G-PULL-FIRST | Lade opencode-flow-plan – ich möchte eine Änderung in OpenCode planen. |
