...
**109 tables** across `website` and `postgres` databases, organized into 8 domains.
...
erDiagram
  ...
  billing_quotes {
    ...
    decimal gross_amount
    string notes
    string converted_to_invoice_id FK
    timestamp created_at
  }
  billing_suppliers {
    string id PK
  ...
  billing_invoices ||--o{ billing_quotes : ""
