...
$CONFIG = [
  ...
  'oidc_login_logout_url'        => 'http://' . getenv('KC_DOMAIN') . '/realms/homeoffice/protocol/openid-connect/logout?client_id=nextcloud&post_logout_redirect_uri=' . urlencode('http://' . getenv('NC_DOMAIN')),
