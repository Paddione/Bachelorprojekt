...
for var in NEXTCLOUD_OIDC_SECRET \
           ...
           PROD_DOMAIN RECOVER_DOMAIN DEV_DOMAIN KC_USER1_EMAIL KC_USER2_EMAIL \
           SMTP_HOST SMTP_PORT SMTP_FROM SMTP_USER SMTP_PASSWORD \
           BRETT_OIDC_SECRET COMFY_OIDC_SECRET BRAINSTORM_OIDC_SECRET \
           MEDIAVIEWER_OIDC_CLIENT_SECRET RECOVERY_OIDC_SECRET VIDEOVAULT_OIDC_SECRET \
