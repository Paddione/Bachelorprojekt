...
- [x] **Failing-Test-Step (RED).** Run the BATS test verifying the [id] dynamic routes exist in the Astro pages tree.
...
- [x] **Task 1: Move job-specific endpoints into [id]/ directory.**
...
- [x] **Task 2: Add spec tests asserting [id] dynamic routes exist in Astro pages tree.**
...
- [x] **Task 3: Run unit and BATS tests (GREEN).**
