  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-tools">
        ...
        <button className="btn btn-ghost btn-sm" onClick={()=> window.open("Praesentation.html","_blank")} title="Präsentationsfenster"><Icon.present width="14" height="14"/>Präsentation</button>
