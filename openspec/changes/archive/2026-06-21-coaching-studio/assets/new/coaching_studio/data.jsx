...
// Jede Ebene: Nr · Name · Ziel · Standard-Prompt (editierbar, rücksetzbar)
// ---------------------------------------------------------------------
const LEVELS = [
...
// ---------------------------------------------------------------------
// PROFILFRAGEN — dynamisch, im Admin erweiterbar. Jeder Wert mit Checkbox:
// nur aktive Werte gehen in die KI-Anfrage.
// ---------------------------------------------------------------------
...
// rtl-Flag steuert RTL-Layout. TTS-Buttons sind reine UI-Zustände.
// ---------------------------------------------------------------------
