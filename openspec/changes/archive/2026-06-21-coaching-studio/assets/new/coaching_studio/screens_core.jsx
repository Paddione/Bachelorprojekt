  ...
  return (
    <div className="screen"><div className="wrap">
      ...
      <div className="akte-grid">
        {/* Aside: Stammdaten + KI-Profil (genau eins) */}
            ...
            {k.sessions.map(s=> (
              <div key={s.id} className="session-row">
                ...
                <div className="acts">
                  ...
                  <button className="btn btn-ghost btn-sm" onClick={()=> window.open("Export.html","_blank")} title="Exportieren"><Icon.printer width="13" height="13"/>Export</button>
                </div>
              </div>
            ))}
          </div>
