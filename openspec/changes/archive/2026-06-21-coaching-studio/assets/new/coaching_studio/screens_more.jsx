...
//     Als eigenes Fenster gedacht; hier als App-Screen.
// =====================================================================
function CompareView({ customer, onNav }){
  const k = customer || CUSTOMERS[0];
  // Platzhalter: einige Ebenen weichen ab (diff), andere identisch.
      ...
      <div className="page-head">
        ...
        <div className="between" style={{alignItems:"flex-end"}}>
          ...
          <div className="row gap-sm">
            ...
            <button className="btn btn-ghost btn-sm" onClick={()=> window.open("Export.html","_blank")}><Icon.printer width="13" height="13"/>Export</button>
          </div>
        </div>
      </div>
