...
- [ ] **Start auf `./node_modules/.bin/tsx` umstellen** (`daemon-runtime-contract.bats`, Zeile 77).
...
- [ ] **Beenden über die selbstgeschriebene PID.** Die bisherige `daemon.pid` im Testverzeichnis
...
- [ ] **Kommentar im Testblock richtigstellen.** Der Block ab Zeile 77 begründet den großzügigen
...
- [ ] **Zweifachlauf gegen Rückstände.** Zweimal hintereinander ausführen — beim zweiten Mal darf
...
- [ ] **Gesamte Cockpit-Suite grün fahren**, beide Dateiformen (T002696), und danach auf
      Rückstände prüfen:
