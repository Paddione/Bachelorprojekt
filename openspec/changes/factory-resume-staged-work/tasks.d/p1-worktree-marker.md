...
- [ ] **P1.1 — Ist-Stand lesen.** Der bestehende Branch-Existenz-Check (`BRANCH_EXISTS`, ab Zeile
...
- [ ] **P1.2 — Belegung prüfen, bevor `git worktree add` läuft.** Nach der Auflösung von `$BRANCH`
...
- [ ] **P1.3 — Markerzeile und Exit-Code.** Bei Belegung eine feste, maschinenlesbare Zeile nach
...
- [ ] **P1.4 — Der Rollback darf nicht greifen.** Der bestehende Rollback-Trap (ab Zeile 109)
...
- [ ] **P1.5 — Der Erfolgsfall bleibt wortgleich.** Die Erfolgszeile enthält weiterhin `ready on`.
...
- [ ] **P1.6 — Manuell verifizieren.** Der Branch dieses Changes ist bereits ausgecheckt, also ist
...
- [ ] **P1.7 — Gegenprobe mit freiem Branch.** Ein nicht ausgecheckter Branch muss weiterhin
