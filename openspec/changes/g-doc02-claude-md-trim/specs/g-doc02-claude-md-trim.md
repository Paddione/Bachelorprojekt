...
- REQ-1: The measure command `wc -l < CLAUDE.md` is reproducible and returns the authoritative line count. The health-goals script invokes this command directly; no approximation or alternative metric is accepted.
