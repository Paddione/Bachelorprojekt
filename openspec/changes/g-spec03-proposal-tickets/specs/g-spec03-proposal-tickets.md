...
- REQ-1: Der Measure-Command `m=0; for d in openspec/changes/*/; do b=$(basename "$d"); [ "$b" = archive ] && continue; [ -f "$d/.ticket" ] || m=$((m+1)); done; echo "no-ticket=$m"` ist jederzeit reproduzierbar ausführbar und liefert einen numerischen Wert.
