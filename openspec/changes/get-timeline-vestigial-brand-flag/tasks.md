...
- [ ] **Fix-Step (GREEN) — `scripts/ticket.sh`.** In `cmd_get_timeline`:
...
- [ ] **Fix-Step (GREEN) — `scripts/lib/ticket-help.sh`.** Im
...
- [ ] **Fix-Step (GREEN) — `scripts/ticket-mcp/go/internal/tools/list.go`.**
...
- [ ] **Fix-Step (GREEN) — `scripts/ticket-mcp-node/server.mjs`.** In
