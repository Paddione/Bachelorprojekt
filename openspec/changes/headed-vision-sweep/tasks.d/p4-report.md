...
- [ ] **Urteilsdatei einlesen, wenn vorhanden.** `vision-<viewport>.json` neben der bestehenden
...
- [ ] **Befund am Bild markieren.** Kacheln mit `verdict: "suspect"` bekommen eine sichtbare
...
- [ ] **Übersprungene und unbrauchbare Zeilen getrennt ausweisen.** `skipped` (kein Endpunkt)
...
- [ ] **Zusammenfassung oben.** Eine Zeile je Brand und Viewport: wie viele Routen beurteilt,
