...
- [ ] **Schritt 8.5 im Skill korrigieren.** Der Auswahlbefehl, der zwischen 8094 und 8091 wählt,
...
- [ ] **Den toten Aufruf in `k8-headed-verify.spec.ts` umhängen.** Vorgabe für `K8_VISION_URL`
...
- [ ] **Den Prosa-Text im Kopf des Spec mitziehen.** Die Kommentarzeile nennt Port 8094
      ausdrücklich; bleibt sie stehen, ist der nächste Leser wieder auf demselben Irrweg.

- [ ] **Die Frage stellen, ob der Aufruf leise scheitern darf.** Er darf — aber die Annotation
