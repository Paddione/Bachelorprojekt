...
- [ ] **1. Repo wird während Hygiene-Lauf live mutiert — §0-Patch-Snapshots veralten lautlos** (suspicious, skills/repo-hygiene) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **2. T013676/T013677-Branches ohne Upstream — Worktree war einzige Kopie der Arbeit** (degraded, repo/git-hygiene) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **3. Hauptcheckout-Patches ohne Ticket/Commit: brain-ingest.sh, brain-ingest-transform.sh, loadouts.json (neuere Iteration)** (suspicious, scripts/brain-ingest) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **4. Orphane brain-ingest-Watcher-PID 4065280: pgrep-Selbstmatch, Loop terminiert nie** (degraded, scripts/brain-ingest-swap.sh) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **5. factory.locked=true (Runtime-Pin) in T013676-Securing-Commit cb1f0d558 committed** (drift, scripts/llm/loadouts.json) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **6. Brain-Ingest-Lauf 2026-08-22 17:14 fehlgeschlagen: Coverage-Gate 88% < 95%** (degraded, scripts/brain-ingest.sh) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **7. vda.sh oracle unerreichbar — weder Hermes noch OpenClaw daemon aktiv** (degraded, scripts/vda.sh) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **8. T013316-reuse Worktree mid-session extern neu erstellt — uncommitteter RED-Test verloren** (suspicious, scripts/hygiene worktree cleanup) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **9. Nackte '!'-Pipeline als BATS-Assertion wirkungslos — bash-errexit-Ausnahme verschleiert die fehlschlagende Zeile** (drift, tests/bats-conventions) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
- [ ] **10. Commit-msg-Hook lehnte 'openspec'-Scope ab; Debug-Tippfehler erzeugte Scheinwiderspruch** (process, repo/git-hooks) — Disposition: _<gefixt | bereits gefixt | kein Repo-Fix | beobachten (bis Zyklus <JJJJ-MM-TT>)>_ + Begruendung
