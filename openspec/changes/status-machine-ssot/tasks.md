...
- [ ] **Failing-Test-Step (RED).** Run unit test for the new status module before implementing it.
      expected: FAIL
...
- [ ] **Create Status SSOT Module (GREEN).**
...
- [ ] **Refactor Consumers to Import from SSOT (GREEN).**
