...
- [x] **RED bestaetigen, bevor p1 bis p3 umgesetzt werden.**
...
- [x] **GREEN nach p1 und p2.** Derselbe Aufruf liefert 5/5 ok. Tests nicht anpassen, um gruen zu
  werden.

- [x] **Test-Inventar neu erzeugen.**
