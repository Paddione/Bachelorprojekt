...
_Purpose fehlt — beim nächsten inhaltlichen Delta zu batch-local-test-runner-fixes ergänzen._
...
<!-- merged from change delta batch-local-test-runner-fixes.md (d77147dc1943) -->