...
- **GIVEN** das Repo enthält `components/website/src/pages/sdlc/api/codesearch.ts`
...
- **GIVEN** `components/website/src/components/sdlc/factory/DetailPanel.svelte` ist vorhanden
...
<!-- merged from change delta brett.md (70b1a2d1225c) -->

<!-- merged from change delta brett.md (b4dd6cbb9e33) -->