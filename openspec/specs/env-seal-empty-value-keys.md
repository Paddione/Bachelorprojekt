...
_Purpose fehlt — beim nächsten inhaltlichen Delta zu env-seal-empty-value-keys ergänzen._
...
<!-- merged from change delta env-seal-empty-value-keys.md (cfb6ed691e25) -->