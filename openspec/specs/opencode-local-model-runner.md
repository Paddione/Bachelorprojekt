...
_Purpose fehlt — beim nächsten inhaltlichen Delta zu opencode-local-model-runner ergänzen._
...
<!-- merged from change delta opencode-local-model-runner.md (e677e501461e) -->