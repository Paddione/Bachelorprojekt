...
_Purpose fehlt — beim nächsten inhaltlichen Delta zu pocket-id-seed-label-isolation ergänzen._
...
<!-- merged from change delta pocket-id-seed-label-isolation.md (2929fb8dc48b) -->