...
`components/website/src/data/openspec-status.json` after moving the change to the archive, regardless of
...
- **AND** `components/website/src/data/openspec-status.json` SHALL be part of the staged set
...
<!-- merged from change delta scripts.md (1ca55bdb2605) -->
...
<!-- merged from change delta scripts.md (116d6a47a6b0) -->