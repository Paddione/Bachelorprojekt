...
const baseline = {
  'S1:components/website/src/pages/big.astro': {
    gate: 'S1', path: 'components/website/src/pages/big.astro', metric: 612,
...
test('removes FIXED entries (key absent from current violations)', () => {
  ...
  const current = [
    { key: 'S1:components/website/src/pages/big.astro', path: 'components/website/src/pages/big.astro', metric: 612, detail: '612 lines > 400' },
...
test('updates lowered metric values (metric improved but violation still present)', () => {
  ...
  const current = [
    { key: 'S1:components/website/src/pages/big.astro', path: 'components/website/src/pages/big.astro', metric: 450, detail: '450 lines > 400' },
  ...
  assert.equal(updated['S1:components/website/src/pages/big.astro'].metric, 450);
  assert.equal(updated['S1:components/website/src/pages/big.astro'].detail, '450 lines > 400');
});
