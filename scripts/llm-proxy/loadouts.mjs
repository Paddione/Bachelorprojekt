...
// [T900107] findExclusiveConflict und planAutoStart sind entfallen.
//
// Beide gehoerten zur exclusiveGroup-Arbitrierung: sie entschieden, welches
// Loadout die GPU belegen darf und welches dafuer weichen muss. Der Proxy
// laeuft seit dem dev-pod-Umzug im Cluster, wo keine GPU zur Verfuegung steht
// und keine systemd-User-Session existiert — es gibt nichts mehr zu
// arbitrieren. Der Rest dieses Moduls bleibt: er liest und schreibt die
// Konfiguration, die das SDLC-Cockpit und der Modell-Lock der Factory
// benutzen.
