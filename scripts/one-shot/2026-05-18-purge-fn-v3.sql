...
COMMENT ON FUNCTION tickets.fn_purge_test_data() IS
  'Idempotent test-data purge. v3 (2026-05-18) extends v2 by sweeping '
  'knowledge.collections based on e2e-* naming patterns. Returns JSONB '
  'of per-table delete counts.';
