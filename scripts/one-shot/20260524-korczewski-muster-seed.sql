...
-- site_settings uses DO NOTHING so admin edits made after first seed are preserved.

BEGIN;

-- ── Mustervertrag ────────────────────────────────────────────────────────────
-- document_templates has no brand column; all templates are cluster-wide.
-- Title 'Mustervertrag' uniqueness is enforced by the WHERE NOT EXISTS guard.
...
-- DO NOTHING preserves any admin edits made after first seed.
