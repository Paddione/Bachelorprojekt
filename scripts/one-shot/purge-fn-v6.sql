-- 2026-07-08 — Migration: tickets.fn_purge_test_data() v6 (T001638).
--
-- Adds a coaching-sessions sweep on top of v5: coaching.sessions.is_test_data
-- flags seed/E2E-created coaching sessions (new column, T001638 migration
-- 2026-07-08-coaching-is-test-data.sql). Without this sweep, flagged coaching
...
COMMENT ON FUNCTION tickets.fn_purge_test_data() IS
  'Idempotent test-data purge. v6 (2026-07-08, T001638): adds a coaching '
  'sessions sweep (coaching.sessions.is_test_data + coaching.session_steps) '
  'on top of the v5 unmarked-identity re-marking sweeps.';
