#!/usr/bin/env node
// Generates components/website/public/systembrett/systembrett.whiteboard.
...
const outPath   = resolve(__dirname, "../components/website/public/systembrett/systembrett.whiteboard");
