...
const SUGGESTED_FILES: SuggestedFile[] = [
  ...
  { path: 'components/website/src/lib/sdlc/codesearch-db.ts', score: 0.87, snippet: 'Semantic search queries with graph augmentation' },
  { path: 'components/website/src/pages/sdlc/api/codesearch.ts', score: 0.81, snippet: 'GET /api/codesearch endpoint' },
];
