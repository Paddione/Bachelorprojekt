...
#
# Prueft die Kerninvarianten der opencode-Agenten-/Modellkonfiguration:
#   1. big-pickle-Limit ist auf 260000 kalibriert (Free-Quota, models.dev 256k-Basis)
#   2. der Sync nach ~/.config/opencode ist idempotent (dry-run liefert leeren diff)
#   3. tot verifizierte Provider tragen einen // stale:-Marker
#
