...
# ausschliesslich im Quelltext: der Default-Wert der OpenSpec-Such-URL in den
# Konsumenten (factory-mcp Go-Server, plan-context.sh). Geprueft wird die Semantik
# des Defaults (localhost statt svc.cluster.local), nicht dessen Darstellung —
# Substring-Proben ohne Zeilenanker (T002716). Der Legacy-Node-Server wurde mit
# T014936 entfernt; sein Fall ist entfallen.
#
