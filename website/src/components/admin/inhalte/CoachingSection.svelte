<script lang="ts">
  ...
  async function save(){
    saving=true;msg='';
    try{
      const res=await fetch('/api/admin/coaching/save',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify(data)});
...
<div class="pt-6 pb-20 space-y-10">
  <div class="flex justify-between items-start">
    <div><h2 class="text-2xl font-bold text-light font-serif">Coaching</h2><p class="text-muted mt-1 text-sm">Inhalte der Coaching-Seite bearbeiten</p></div>
