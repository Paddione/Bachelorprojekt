...
const RAW_GOALS: HealthGoal[] = [
  ...
  },
  {
    ...
    baseline: 39, current: 0, target: 0, unit: 'Images',
    status: 'achieved',
    measurement: "grep -rhE '^[[:space:]]*-?[[:space:]]*image:' k3d/ prod*/ --include='*.yaml' --include='*.yml' 2>/dev/null | grep -v '@sha256' | grep -vE 'website|brett|docs|videovault|mentolder-web|paddione|_IMAGE' | sort -u | wc -l",
  ...
  },
  {
    ...
    priority: 'C', direction: 'lower',
    baseline: 3, current: 0, target: 0, unit: 'Deployments',
    status: 'achieved',
  ...
  },
  {
    ...
    priority: 'C', direction: 'lower',
    baseline: 12, current: 0, target: 0, unit: 'Changes',
    status: 'achieved',
  ...
  },
  {
    ...
    priority: 'C', direction: 'lower',
    baseline: 273, current: 198, target: 200, unit: 'Zeilen',
    status: 'achieved',
  ...
  },
  {
    ...
    priority: 'C', direction: 'higher',
    baseline: 0, current: 5, target: 5, unit: 'ADRs',
    status: 'achieved',
  ...
  // ── Priority C — Green Gates (erreicht, halten) ───────────────────────
  {
    ...
    priority: 'C', direction: 'lower',
    baseline: 98, current: 26, target: 30, unit: 'Violations',
    status: 'achieved',
