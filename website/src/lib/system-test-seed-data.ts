...
export const SYSTEM_TEST_TEMPLATES: SystemTestTemplate[] = [
  {
    ...
    instructions: 'Führe die Schritte in zwei separaten Browser-Profilen aus (Admin + Testnutzer). Öffne die verlinkte Seite im jeweiligen Profil. Wähle pro Schritt das Ergebnis und trage Auffälligkeiten in das Detailfeld ein.',
    steps: [
      ...
      { question_text: 'Öffne das Portal (Link) in einem Browser-Profil ohne aktive Admin-Session — melde den Testnutzer über Keycloak an und prüfe ob Profilname stimmt.',
      ...
      { question_text: 'Öffne Nextcloud (Link) während die Testnutzer-Session aktiv ist — du solltest ohne erneute Passwort-Eingabe automatisch eingeloggt werden und die Dateiansicht sehen.',
      ...
      { question_text: 'Öffne Vaultwarden (Link) mit der aktiven Testnutzer-Session — der SSO-Login sollte automatisch den Passwort-Tresor öffnen.',
        expected_result: 'Automatischer Login; Passwort-Tresor wird geladen.',
        test_function_url: `https://vault.${D}`, test_role: 'user' },
      { question_text: 'Öffne DocuSeal (Link) mit der aktiven Testnutzer-Session — der SSO-Login sollte automatisch die Dokumentenliste anzeigen.',
  ...
  },
  {
    ...
    steps: [
      ...
      { question_text: 'Öffne Einstellungen → Branding (Link) — klicke "Logo hochladen", wähle eine Bilddatei und speichere; das Logo sollte im Admin-Header und auf der öffentlichen Website erscheinen.',
  ...
  },
  {
    ...
    steps: [
      { question_text: 'Öffne die Website (Link) als angemeldeter Testnutzer — das Fragebogen-Widget (📋-Symbol rechts unten) sollte sichtbar sein; klicke es an und prüfe ob ausstehende Fragebögen in der Liste erscheinen.',
  ...
  },
  {
    ...
    steps: [
      ...
      { question_text: 'Klicke im Template auf "Veröffentlichen" — öffne dann einen Client (Link), wechsle zum Reiter "Fragebögen" und klicke "Zuweisen".',
        ...
        test_function_url: '/admin/clients', test_role: 'admin' },
      { question_text: 'Melde dich als Testnutzer im Portal an (Link) — der neue Fragebogen sollte im Dashboard unter "Ausstehende Fragebögen" sichtbar sein; klicke ihn an und beantworte alle Fragen.',
  ...
  },
  {
    ...
    steps: [
      ...
      { question_text: 'Öffne Dokumente (Link) → wähle ein Dokument aus → klicke "Zur Unterschrift senden" → wähle den Testnutzer als Empfänger.',
        ...
        test_function_url: '/admin/dokumente', test_role: 'admin' },
      { question_text: 'Öffne DocuSeal (Link) als Testnutzer — rufe den Signatur-Link aus der E-Mail auf, unterzeichne das Dokument und schließe den Vorgang ab.',
  ...
  },
  {
    ...
    instructions: 'Alle Schritte im Admin-Browser. Öffne jeweils den Link im Schritt. Schritte 4–6 erfordern künstliche Umsatzwerte (z. B. via SQL oder Test-Modus).',
    steps: [
      ...
      { question_text: 'Öffne das Steuer-Dashboard (Link) — erhöhe den Testumsatz auf ≥ 80 % von 25.000 € und prüfe ob ein gelber Warn-Alert im TaxMonitorWidget erscheint [B-03].',
      ...
      { question_text: 'Öffne das Steuer-Dashboard (Link) — überschreite die 25.000 €-Grenze und prüfe ob ein roter Alert und der automatische Switch auf Regelbesteuerung ausgelöst wird [B-03/B-04].',
      ...
      { question_text: 'Öffne das Steuer-Dashboard (Link) — überschreite die 100.000 €-Grenze und prüfe ob ein roter "Sofort Regelbesteuerung"-Alert erscheint [B-06].',
  ...
  },
  {
    ...
    instructions: 'Alle Schritte im Admin-Browser. Öffne jeweils den Link im Schritt. Für Schritt 8 wird ein PDF-Tool (pdftk/qpdf) benötigt, um eingebettete XML zu prüfen.',
    steps: [
      ...
      { question_text: 'Lade die PDF einer finalisierten Rechnung herunter — prüfe in der Kommandozeile mit "pdftk dump_data_fields" oder "qpdf --show-attachments" ob factur-x.xml eingebettet ist [A-08].',
      ...
      { question_text: 'Öffne eine finalisierte Rechnung in der Datenbank (z. B. über /admin/monitoring oder direkte DB-Abfrage) — prüfe ob retain_until = Rechnungsdatum + 10 Jahre gesetzt ist [A-10].',
  ...
  },
  {
    ...
    instructions: 'Alle Schritte im Admin-Browser. Öffne jeweils den Link im Schritt. Letzter Schritt erfordert eine Beleg-Datei (PDF oder Bild).',
    steps: [
      ...
      { question_text: 'Öffne Buchhaltung (Link) → wähle eine Buchung aus → klicke "Beleg anhängen" → lade eine PDF oder ein Bild hoch — prüfe ob der Beleg dauerhaft mit der Buchung verknüpft ist [C-13].',
  ...
  },
  {
    ...
    instructions: 'Alle Schritte im Testnutzer-Browser, sofern nicht anders angegeben. Klicke den Link im jeweiligen Schritt, um direkt zur richtigen Seite zu gelangen.',
    steps: [
      ...
      { question_text: 'Öffne Nextcloud Talk (Link) → betrete einen Raum → aktiviere Audio/Video über die Schaltflächen unten — prüfe ob das lokale Video im Raum erscheint.',
