...
// Internal imports from website-core-db.ts (T002149) — used by functions
// that remain in this file (assignMeeting, listBugTickets).
import { upsertCustomer } from './website-core-db';
import type { BugTicketRow } from './website-core-db';

// ── T002149: Customer / Bug Tickets / Site Settings / Vacation / Legal Pages ──
// Re-exported from website-core-db.ts for backward compatibility.
export {
  // Customer
...
// ── Customer ────────────────────────────────────────────────────────────────
// Customer functions moved to website-core-db.ts (T002149).
...
// ── Bug Tickets ──────────────────────────────────────────────────────────────
// Bug Tickets functions moved to website-core-db.ts (T002149).
// BugTicketRow re-exported from website-core-db.ts for listBugTickets.
...
// ── Site Settings / Vacation / Legal Pages ───────────────────────────────────
// Functions moved to website-core-db.ts (T002149).
...
// Legal Pages functions moved to website-core-db.ts (T002149).
